...
<body class="font-sans antialiased bg-[#FDFDFC] text-[#1b1b18]">
    ...
    <div id="toastContainer" class="fixed top-5 right-5 z-[200] min-w-[300px] transition-all duration-300 toast-hidden">
        <div id="toastBox" class="rounded-2xl border px-6 py-4 shadow-xl flex items-center justify-between border-l-4">
    ...
    <script>
        ...
        function showToast(msg, type = 'success') {
            ...
            if (type === 'success') {
                box.className =
                    'rounded-2xl border px-6 py-4 shadow-xl flex items-center justify-between border-l-4 bg-emerald-50 border-emerald-400 text-emerald-700';
            } else {
                box.className =
                    'rounded-2xl border px-6 py-4 shadow-xl flex items-center justify-between border-l-4 bg-rose-50 border-rose-400 text-rose-600';
            }
